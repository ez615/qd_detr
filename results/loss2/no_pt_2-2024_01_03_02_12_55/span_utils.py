...
def new_loss(iou_loss_types, spans1, spans2, sims, idx, diou=False):
    spans1 = spans1.float()
    spans2 = spans2.float()
    ...
    ### ING...
    # if len(str(iou_loss_type)) > 1:
    #     types = list(map(int, str(iou_loss_type)))
    new_loss = 1 - iou
