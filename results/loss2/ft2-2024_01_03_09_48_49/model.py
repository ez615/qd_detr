...
class QDDETR(nn.Module):
    ...
    def __init__(self, transformer, position_embed, txt_position_embed, txt_dim, vid_dim,
        ...
        ### ADDED
        self.loss_types = list(map(int, str(loss_type)))
...
class SetCriterion(nn.Module):
    ...
    def __init__(self, matcher, weight_dict, eos_coef, losses, temperature, span_loss_type, max_v_l,
                 saliency_margin=1, iou_loss_type=0, use_matcher=True, diou=False, scheduling=False):
        ...
        self.span_loss_type = span_loss_type
        ### ADDED
        self.iou_loss_types = list(map(int, str(iou_loss_type)))
        self.diou = diou
    ...
    def loss_spans(self, outputs, targets, indices):
        ...
        if self.span_loss_type == "l1":
            ...
            if self.iou_loss_types[0] == 0:
                ...
                loss_giou = new_loss(self.iou_loss_types, span_cxw_to_xx(src_spans), span_cxw_to_xx(tgt_spans), outputs['sims'], idx[0], self.scheduling)
