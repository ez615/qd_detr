...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, video_length=None):
        ...
        src, attn_weight = self.t2v_encoder(src, src_key_padding_mask=mask, pos=pos_embed, video_length=video_length)  # (L, batch_size, d)
        ...
        memory, _ = self.encoder(src, src_key_padding_mask=mask, pos=pos_embed)  # (L, batch_size, d)
        ...
        return hs, references, memory_local, memory_global, attn_weight
...
class T2V_TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self,
        ...
        src2, attn_weight = self.self_attn(q, k, value=v, attn_mask=attn_mask,
