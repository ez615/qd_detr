...
class QDDETR(nn.Module):
    ...
    def forward(self, src_txt, src_txt_mask, src_vid, src_vid_mask, src_aud=None, src_aud_mask=None):
        ...
        hs, reference, memory, memory_global, crs_attn_weight = self.transformer(src, ~mask, self.query_embed.weight, pos, video_length=video_length)  # memory_global shape: [bsz, hidden_dim]
        ...
        out['attn_weights'] = crs_attn_weight
